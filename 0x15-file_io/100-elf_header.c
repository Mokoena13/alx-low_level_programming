 ...
 * @e_ident: pointer to an array that contains the ELF magic numbrs.
...
/**
 * print_magic - it prints the magic numbrs of an ELF header.
 * @e_ident: pointer to an array that contains the ELF magic numbrs.
 ...
 * @argc: numbr of arguments that are supplied to the program.
