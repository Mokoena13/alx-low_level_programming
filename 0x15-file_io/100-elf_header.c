 ...
 * @e_ident: pointer to array with  ELF magic nums.
...
/**
 *  * print_version - Prints vers of ELF header.
 ...
 * @e_ident: A pointer to array with ELF version.
 */
 ...
 * Return: 0 is success.
 * Description: If the file not ELF File or
